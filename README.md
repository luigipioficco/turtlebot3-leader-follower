...
same `worlds.py` geometry the world file and the trajectory tests already share — a third
consumer of that one source of truth. `leader_follower/target_driver_nav2_node.py`, adapted
