...
def launch_setup(context, *args, **kwargs):
    ...
    #
    # The point is not arbitrary. The target spawns off the route and drives to
    # it in a straight line, with no sensors and avoiding nothing, so that
    # approach leg must be clear as well.
